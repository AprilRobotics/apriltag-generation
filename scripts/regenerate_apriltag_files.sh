...
for name in ${NAMES[*]}; do
    ...
    cat scripts/copyright.txt > ../apriltags/t$name.c
    cat t$name.c >> ../apriltags/t$name.c
    rm t$name.c

    cat scripts/copyright.txt > ../apriltags/t$name.h
    cat t$name.h >> ../apriltags/t$name.h
    rm t$name.h
done
